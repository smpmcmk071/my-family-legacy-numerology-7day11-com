      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6 flex items-center justify-center">
        <Card className="bg-white/10 backdrop-blur-sm border-white/20 max-w-md">
          <CardContent className="py-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Community Disabled</h2>
            <p className="text-gray-300">Community features have been disabled by your family admin.</p>
          </CardContent>
        </Card>
      </div>
    );
